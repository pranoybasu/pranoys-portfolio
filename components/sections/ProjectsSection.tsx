  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 bg-gradient-to-br from-cosmic-blue/20 to-cosmic-cyan/20 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-cosmic-darker/90 to-transparent" />
      </div>
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <a
            ...
            className="flex-1 px-4 py-2 rounded-lg text-center font-semibold transition-all duration-200 bg-gradient-to-r from-cosmic-blue to-cosmic-cyan text-white hover:shadow-lg hover:shadow-cosmic-blue/50"
          >
            Live Demo
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 rounded-lg border font-semibold transition-all duration-200 border-cosmic-blue/50 text-cosmic-blue hover:bg-cosmic-blue/10"
          >
            GitHub
          </a>
        </div>
