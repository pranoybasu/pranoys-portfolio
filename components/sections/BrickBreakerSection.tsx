    ...
    <section id="brick-breaker" className="relative py-24 px-4">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="glass rounded-2xl p-8 md:p-12 border-2 border-yellow-500/30 hover:border-yellow-400/50 transition-all duration-300 bg-gradient-to-br from-yellow-500/5 to-orange-500/5"
        >
          {/* Header */}
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 text-center">
              My coding journey started in <span className="text-yellow-400 font-semibold">Class 10</span> when I created this Brick Breaker game in Java. 
              It was my first real project, and it sparked a passion that led me to where I am today.
            </p>
            
            <div className="glass rounded-lg p-6 border border-yellow-500/20 bg-yellow-500/5">
              <div className="flex items-start gap-4">
                <div className="text-3xl">💡</div>
                <div>
                  <h3 className="text-xl font-semibold text-yellow-400 mb-2">A Developer's Origin Story</h3>
          ...
          >
            <button
              ...
              className="group relative px-12 py-5 rounded-xl font-bold text-xl bg-gradient-to-r from-yellow-400 to-orange-500 text-cosmic-darker hover:shadow-2xl hover:shadow-yellow-500/50 transition-all duration-300 transform hover:scale-105 active:scale-95"
            >
            ...
            >
              <span className="inline-block px-3 py-1 rounded-full bg-yellow-500/5 border border-yellow-500/20">
          ...
          {!showGame && (
            ...
            >
              <div className="glass rounded-lg p-4 border border-yellow-500/10">
                <div className="text-2xl mb-2">📅</div>
                <div className="text-yellow-400 font-semibold">2016</div>
                <div className="text-sm text-gray-500">Year Created</div>
              </div>
              
              <div className="glass rounded-lg p-4 border border-yellow-500/10">
                <div className="text-2xl mb-2">☕</div>
                <div className="text-yellow-400 font-semibold">Java → JavaScript</div>
                <div className="text-sm text-gray-500">Technology Evolution</div>
              </div>
              
              <div className="glass rounded-lg p-4 border border-yellow-500/10">
                <div className="text-2xl mb-2">🎯</div>
                <div className="text-yellow-400 font-semibold">First Project</div>
                <div className="text-sm text-gray-500">That Started It All</div>
              </div>
            </motion.div>
          )}
        </motion.div>
